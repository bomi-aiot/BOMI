...
| 독자 | 바로 가기 |
| --- | --- |
| 처음 오셨다면 | [시연 시나리오](#시연-시나리오-네-가지) · [시스템 구성](#시스템-구성) · [구현 및 검증 현황](#구현-및-검증-현황) |
| 팀에 합류한다면 | [빠른 시작](#빠른-시작) · [저장소 구조](#저장소-구조) · [CONTRIBUTING.md](CONTRIBUTING.md) |
| 계약을 확인한다면 | [MQTT 시나리오 계약 v1](docs/mqtt/scenario-contract-v1.md) · [API·메시지 문서](docs/api/README.md) |
