...
flowchart LR
  ...
  Robot -->|상태 및 수행 결과| BE
  Robot <-->|REST / Stream| AI["대화 및 Vision AI"]
...
- **REST**: 명확한 요청·응답과 기록 조회
- **WebSocket**: 보호자 대시보드에 실시간 상태 전달
...
| AI | Python 3.10, STT/TTS, 대화 런타임, Vision |
...
infra/      Docker, Mosquitto, Jenkins 및 Nginx 설정
...
- [MQTT 연동 계약](docs/mqtt/backend-robot-contract.md)
