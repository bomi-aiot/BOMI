...
> |---|---|
> | 왜 이렇게 설계했나 | **이 문서** |
> | 지금 무엇이 되고 무엇이 안 되나 | [`docs/carebot/PROGRESS.md`](../carebot/PROGRESS.md) |
> | 지금 상수 값이 얼마인가 | `robot/ai_chat/src/bomi_ai_chat/policy.py` |
> | 지금 계약(MQTT·HTTP)이 무엇인가 | `CLAUDE.md`, [`docs/mqtt/scenario-contract-v1.md`](../mqtt/scenario-contract-v1.md) |
>
...
> §12.10 의 통신 단절 감시도 돌지 않는다. 최신 상태는 [`docs/carebot/PROGRESS.md`](../carebot/PROGRESS.md) 를 본다.
...
> 현행 진척의 권위는 [`docs/carebot/PROGRESS.md`](../carebot/PROGRESS.md) 다.
