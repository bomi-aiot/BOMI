...
| 208 | 현관·재실 | 완료 | 통과 | **미실시** | 푸시됨 |
| 209 | 온보딩·재질의 | **막힘** | — | — | — |
| 210 | 트리아지·T1 | 미착수 | — | — | — |
| 211 | T2 요약·보호자 채널 | 미착수 | — | — | — |
| 212 | 회귀 세트·튜닝 | 미착수 | — | — | — |
| **218** | **Qdrant 벡터 스토어** | **미착수** | — | — | — |
| **226** | **BE 현관 방향 판정·인사 결정** | **미착수** | — | — | — |
| **227** | **BE 온보딩·재질의 계약 API** | **미착수** | — | — | — |

218·226·227 은 원래 계획에 없던 신설 티켓입니다. 사유는 §3.

**209 가 '막힘'인 이유**: 로봇이 호출할 백엔드 API 가 없습니다. 227 이 선행입니다. §2.6 참고.

**자동 검증 현황**: 로봇 316건 통과 / 백엔드 106건 통과, 둘 다 lint 통과.
...
### 2.6 로봇→백엔드 '쓰기' 경로가 하나도 없습니다

203 이 만든 것은 **읽기 전용 문맥 조립**뿐입니다. 로봇이 백엔드에 무언가를 남기는 API 는 아직 없습니다. 이것이 티켓 세 개를 동시에 막고 있습니다.

| 없는 것 | 막히는 것 |
|---|---|
| 온보딩 세션 진행·답변 제출 | **209 전체** → 227 신설 |
| 활성 `fact_candidate` 조회·응답 | **209 전체** → 227 신설 |
| 대화 이벤트 적재(`conversation_message`) | 211 의 발화량 지표. 지금은 통째로 NULL |
