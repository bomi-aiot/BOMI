...
> **마지막 갱신**: 296·297 푸시 직후 (2026-08-04)
>
...
| 212 | 회귀 세트·튜닝 | **절반 완료** | 통과 (신규 45건) | **미실시** | 푸시됨, **미머지** |
...
**212·233 은 `ai-develop` 에 아직 없습니다.** 각자의 브랜치에 푸시된 상태이고, 위 표의 "절반 완료 / 부분 실시"는 **그 브랜치들을 포함한 전체 상태**입니다. `ai-develop` 만 체크아웃하면 두 티켓의 코드는 보이지 않습니다.
