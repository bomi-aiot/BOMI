# robot/ai_chat/src/apis/medical_apis.py
import os
import requests
...
class MedicalDataClient:
    def __init__(self):
        self.hospital_key = os.getenv("HIRA_HOSPITAL_API_KEY")
        self.pharmacy_key = os.getenv("HIRA_PHARMACY_API_KEY")
        self.dur_key = os.getenv("DUR_PRDLST_API_KEY")
