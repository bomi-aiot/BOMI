...
(
    '80000000-0000-4000-8000-000000000002',
    '10000000-0000-4000-8000-000000000001',
    -- ★ parent_record_id. NULL 이었다.
    --
    --   MEDICATION_SCHEDULE 이 자기 MEDICATION 을 가리키지 않으면 조회 두 곳이 동시에
    --   깨진다. GET /care-records/medications 는 관절염약을 schedules:[] 로 내보내
    --   화면에 복용 시각이 사라지고, medication-responses 는 medicationId:null 을 실어
    --   보호자 화면이 "어느 약의 응답인지" 붙이지 못한다(CarePlanPage 는 medicationId 로
    --   매칭한다). 혈압약은 이 값이 있어서 멀쩡했고, 그래서 한쪽만 깨진 채로 지나갔다.
    '80000000-0000-4000-8000-000000000001',
    '40000000-0000-4000-8000-000000000001',
    '50000000-0000-4000-8000-000000000001',
    '51000000-0000-4000-8000-000000000010',
